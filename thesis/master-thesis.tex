\documentclass[specification,annotation,times]{itmo-student-thesis.cls}
...
\studygroup{M4239}
\title{Применение различных методов параметрически-эффективной тонкой настройки для адаптации языковых моделей для вопросно-ответных систем в предметной области на основе Compute-efficient Retrieval Augmented Fine-Tuning}
\author{Протасов Тимофей Михайлович}{Протасов Т.М.}
\supervisor{Аксенов Виталий Евгеньевич}{Аксенов В.Е.}{доцент., к.т.н.}{главный научный сотрудник Университета ИТМО}
\publishyear{2019}
